    ...
    public class HttpsRequirementAttribute : TypeFilterAttribute
    {
        ...
        private class HttpsRequirementFilter : IAuthorizationFilter
        {
            ...
            protected void RedirectRequest(AuthorizationFilterContext filterContext, bool useSsl)
            {
                ...
                if (filterContext.HttpContext.Connection.RemoteIpAddress.Equals(filterContext.HttpContext.Connection.LocalIpAddress))
                    return;
            ...
            public void OnAuthorization(AuthorizationFilterContext filterContext)
            {
                ...
                var a = filterContext.HttpContext.Connection.RemoteIpAddress.ToString();

                if (filterContext.HttpContext.Connection.RemoteIpAddress.ToString().Equals("::1"))
                    return;
